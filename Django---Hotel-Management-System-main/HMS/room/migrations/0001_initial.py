    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roomType', models.CharField(choices=[('King', 'King'), ('Luxury', 'Luxury'), ('Normal', 'Normal'), ('Economico', 'Economico')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicesType', models.CharField(choices=[('Comida', 'Comida'), ('Limpieza', 'Limpieza'), ('Tecnico', 'Tecnico')], max_length=20)),
                ('price', models.FloatField()),
