    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventType', models.CharField(choices=[('Pelicula', 'Pelicula'), ('Teatro', 'Teatro'), ('Conferencia', 'Conferencia'), ('Concierto', 'Concierto'), ('Entretenimiento', 'Entretenimiento'), ('Musica', 'Musica')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itemType', models.CharField(choices=[('Cocina', 'Cocina'), ('Limpieza', 'Limpieza'), ('Electronicos', 'Electronicos'), ('Lavanderia ', 'Lavanderia '), ('Otros', 'Otros')], max_length=20)),
